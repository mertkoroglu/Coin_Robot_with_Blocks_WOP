...
total = 0;
var flag = 0;
async function robotRun(delay = 5){
    for(i = 0; i<10; i++){
        var visI = i + "a";
        var vis = document.getElementById(visI);
...
async function robotBack(delay = 100){
    ...
    while(j > 0 && i > 0 && (blocks.indexOf(plc) < 0 )){
        plc = i + "" + j + "b";
        if(coins[i][j-1] > coins[i-1][j] && (blocks.indexOf(plc) < 0 )){
            console.log("up");
            id.innerHTML = "";
            colorChange("green");
        ...
        plc = i + "" + j + "b";
        if(coins[i-1][j] >= coins[i][j-1]  && (blocks.indexOf(plc) < 0 )){
            console.log("down");
            id.innerHTML = "";
            colorChange("green");
    ...
    while(j > 0 && (blocks.indexOf(plc) < 0 )){
            plc = i + "" + j + "b";
            id.innerHTML = "";
    ...
    while(i > 0 && (blocks.indexOf(plc) < 0 )){
            plc = i + "" + j + "b";
            id.innerHTML = "";
